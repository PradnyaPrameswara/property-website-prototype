...
- [x] Collections: services (15), portfolio (4), posts (7), categories (3), team (8) — `src/content.config.ts` + 37 entries in `src/content/`, generated by `scripts/extract-content.mjs` (idempotent, re-runnable)
